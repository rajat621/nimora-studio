...
function RiskIcon() {
  return (
    <div className={styles.riskWrapper}>
      <div className={styles.riskArrows}>
        <ArrowDown className={styles.smallArrow} />
        <ArrowDown className={styles.smallArrow} />
        <ArrowDown className={styles.smallArrow} />
      </div>
      <TriangleAlert className={styles.expectIcon} />
    </div>
  );
}
...
const topRow = [
  {
    icon: <MessagesSquare className={styles.expectIcon} />,
    label: "Clear\ncommunication",
  },
  {
    icon: (
      <ChartNoAxesColumnIncreasing className={styles.expectIcon} />
    ),
    label: "Regular\nprogress updates",
  },
  {
    icon: <BadgeCheck className={styles.expectIcon} />,
...
const bottomRow = [
  {
    icon: <RefreshCcw className={styles.expectIcon} />,
    label: "Faster\nfeedback cycles",
  },
  {
    icon: <RiskIcon />,
